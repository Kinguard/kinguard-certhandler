...
deploy_cert() {
    ...
    echo " + HOOK INFO: Deploy Certificate"
    # if nginx is running, restart it. If it is not needed, it will be shut down by "letsencrypt.sh"
...
unchanged_cert() {
    ...
    # - CHAINFILE
    #   The path of the file containing the intermediate certificate(s).
    echo "HOOK INFO: Certificate unchanged"
}
